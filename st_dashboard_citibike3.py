...
### Most popular stations page
    ...
    st.markdown("The bar chart makes it clear that some start stations are more popular than others. Summer is the busiest season, with nearly three times the total rides compared to winter, the least busy season. The top 20 start stations account for just over 6% of all rides in the city, year-round. The top 3 busiest start stations throughout the year, are W 21 St & 6 Ave, West St & Chambers St, and Broadway & W 58 St.") 
    ...
    path_to_html = "citi_rides_aggd.html" 
    ...
    st.markdown("Newport parkway, which is technicaally located in New Jersey, offers views of the New York City skyline. Notable attractions nearby include Pier-A Park, the Hoboken Waterfront, and Newport Centre Mall. This area is also known for its scenic walking paths, and boat tours along the Hudson River.")
    ...
    st.markdown("- Scout new areas for more bike stations near subway entrances, and bus stops, to increase connectivity and supplemental transportation.")
